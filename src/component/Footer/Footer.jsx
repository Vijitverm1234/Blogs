    ...
    <div className="footer">
      ...
      <div className="second">
        ...
        <div className="links">
          ...
          <a href="https://github.com/username" target="_blank" rel="noopener noreferrer" className="links-inside">
          <Github color="#333" size={40} aria-hidden="true" />
         
        </a>
        <a href="https://instagram.com/username" target="_blank" rel="noopener noreferrer" className="links-inside">
          <Instagram color="#333" size={40} aria-hidden="true" />
         
        </a>
        <a href="https://x.com/username" target="_blank" rel="noopener noreferrer" className="links-inside">
          <X color="#333" size={40} aria-hidden="true" />
        
        </a>
        <a href="https://linkedin.com/in/username" target="_blank" rel="noopener noreferrer" className="links-inside">
      ...
      <div className="third">
        ...
        <input type="hidden" name="access_key" value="defcb9f7-0c55-49c3-b552-afa5a246e5e1"></input>
